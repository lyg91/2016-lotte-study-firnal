...
<body>
<h3 class="text-center"><span class="glyphicon glyphicon-zoom-out">Forget your password?</span></h3>
<% if(request.getAttribute("message") != null) { %>
<script>
	alert('<%=request.getAttribute("message")%>');
</script>
<% } %>
<form name="findPwForm" method="post" action="Controller?action=findPw" class="form-horizontal">
  ...
  <div align="right">
	  <div class="form-group">
	    <div class="col-sm-offset-1 col-sm-4">
	      <button type="submit" class="col-sm-2 btn btn-info">비밀번호 찾기</button>
